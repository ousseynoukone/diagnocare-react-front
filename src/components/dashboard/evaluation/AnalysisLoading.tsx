...
export default function AnalysisLoading() {
  ...
  return (
    <div className="min-h-[75vh] w-full flex flex-col items-center justify-center space-y-12 text-center animate-pulse">
      <div className="relative flex items-center justify-center">
        {/* Heartbeat pulse circles */}
        <div className="absolute h-24 w-24 bg-primary-500/25 rounded-full animate-ping"></div>
        <div className="absolute h-28 w-28 bg-primary-500/10 rounded-full animate-ping [animation-delay:0.5s]"></div>
